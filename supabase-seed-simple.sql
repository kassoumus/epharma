-- ========================================
-- EPHARMA - SEED DATA SIMPLIFIÉ
-- ========================================
-- Exécutez ce script pour ajouter les données

-- Nettoyer les données existantes (optionnel)
-- TRUNCATE users, pharmacies, health_centers, doctors, appointments, products, reservations, reviews CASCADE;

-- ========================================
-- PHARMACIES (sans user_id pour l'instant)
-- ========================================
...
-- ========================================
-- DOCTORS (sans user_id pour l'instant)
-- ========================================
